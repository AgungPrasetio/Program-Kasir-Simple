$('document').ready(function () {
    ...
    function formAdd() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionSatuanBarang.php?add',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function addSuccess(){
        $("#form").load("mod/mod_satuan_barang/form.php?add");
        $("#select").load("mod/mod_satuan_barang/select.php?add");
    }
    ...
    function formEdit() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionSatuanBarang.php?edit',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function editSuccess(){
        $("#form").load("mod/mod_satuan_barang/form.php?add");
        $("#select").load("mod/mod_satuan_barang/select.php?edit");
    }
    ...
    function formDelete() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionSatuanBarang.php?delete',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function deleteSuccess(){
        $("#form").load("mod/mod_satuan_barang/form.php?add");
        $("#select").load("mod/mod_satuan_barang/select.php?del");
    }

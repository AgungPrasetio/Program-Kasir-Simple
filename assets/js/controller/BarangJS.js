$('document').ready(function () {
    ...
    function addSuccess(){
        $("#form").load("mod/mod_barang/form.php?add");
        $("#select").load("mod/mod_barang/select.php?add");
    }
    ...
    function editSuccess(){
        $("#form").load("mod/mod_barang/form.php?add");
        $("#select").load("mod/mod_barang/select.php?edit");
    }
    ...
    function deleteSuccess(){
        $("#form").load("mod/mod_barang/form.php?add");
        $("#select").load("mod/mod_barang/select.php?del");
    }

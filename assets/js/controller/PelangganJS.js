$('document').ready(function () {
    ...
    function formAdd() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionPelanggan.php?add',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function addSuccess(){
        $("#form").load("mod/mod_pelanggan/form.php?add");
        $("#select").load("mod/mod_pelanggan/select.php?add");
    }
    ...
    function formEdit() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionPelanggan.php?edit',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function editSuccess(){
        $("#form").load("mod/mod_pelanggan/form.php?add");
        $("#select").load("mod/mod_pelanggan/select.php?edit");
    }
    ...
    function formDelete() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionPelanggan.php?delete',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function deleteSuccess(){
        $("#form").load("mod/mod_pelanggan/form.php?add");
        $("#select").load("mod/mod_pelanggan/select.php?del");
    }

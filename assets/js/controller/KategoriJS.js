$('document').ready(function () {
    ...
    $("#form-add").validate({
        ...
        messages: {
            nama_kategori: "<p style='color:red; font-size:11px; margin:0px; padding:0px;'>Nama kategori tidak boleh kosong</p>",
        },
    ...
    function formAdd() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionKategori.php?add',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function addSuccess(){
        $("#form").load("mod/mod_kategori/form.php?add");
        $("#select").load("mod/mod_kategori/select.php?add");
    }
    ...
    function formEdit() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionKategori.php?edit',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function editSuccess(){
        $("#form").load("mod/mod_kategori/form.php?add");
        $("#select").load("mod/mod_kategori/select.php?edit");
    }
    ...
    function formDelete() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionKategori.php?delete',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function deleteSuccess(){
        $("#form").load("mod/mod_kategori/form.php?add");
        $("#select").load("mod/mod_kategori/select.php?del");
    }

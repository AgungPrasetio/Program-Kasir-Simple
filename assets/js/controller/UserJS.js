$('document').ready(function () {
    ...
    function formAdd() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionUser.php?add',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
            ...
            success :  function(response)
            {
                if(response=="ok"){
                    ...
                    $("#info").fadeIn(300, function(){
                        ...
                        $("#info").html('<div class="alert alert-danger alert-dismissable"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><i class="fa fa-exclamation-circle" aria-hidden="true"></i> &nbsp; Username sudah dipakai!</div>');
    ...
    function addSuccess(){
        $("#form").load("mod/mod_user/form.php?add");
        $("#select").load("mod/mod_user/select.php?add");
    }
    ...
    function formEdit() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionUser.php?edit',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function editSuccess(){
        $("#form").load("mod/mod_user/form.php?add");
        $("#select").load("mod/mod_user/select.php?edit");
    }
    ...
    function formDelete() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionUser.php?delete',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function deleteSuccess(){
        $("#form").load("mod/mod_user/form.php?add");
        $("#select").load("mod/mod_user/select.php?del");
    }

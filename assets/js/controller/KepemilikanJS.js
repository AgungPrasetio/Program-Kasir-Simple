$('document').ready(function () {
    ...
    function formAdd() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionKepemilikan.php?add',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function addSuccess(){
        $("#form").load("mod/mod_kepemilikan/form.php?add");
        $("#select").load("mod/mod_kepemilikan/select.php?add");
    }
    ...
    function formEdit() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionKepemilikan.php?edit',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function editSuccess(){
        $("#form").load("mod/mod_kepemilikan/form.php?add");
        $("#select").load("mod/mod_kepemilikan/select.php?edit");
    }
    ...
    function formDelete() {
        ...
        $.ajax({
            type : 'POST',
            url  : '__class/action/ActionKepemilikan.php?delete',
            data : data,
            beforeSend: function()
            {
                $("#info").fadeOut();
    ...
    function deleteSuccess(){
        $("#form").load("mod/mod_kepemilikan/form.php?add");
        $("#select").load("mod/mod_kepemilikan/select.php?del");
    }
